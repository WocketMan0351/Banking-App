public class CDAccount extends BankAccount {
	...
	/**
	 * @param amt, a double all or nothing withdraw if not mature, incurs a 10%
	 *             penalty and then withdrawals the remaining amount if mature,
	 *             withdrawals the full amount
	 */
